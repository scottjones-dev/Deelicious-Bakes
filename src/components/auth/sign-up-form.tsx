                ...
                <CardContent className="pt-10 pb-10 flex flex-col items-center text-center gap-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <P className="text-muted-foreground text-sm max-w-70">
                            We've sent a verification link to <span className="text-primary font-medium">{emailSentTo}</span>.
    ...
    return (
        <Card {...props} className="border-primary/10 shadow-lg">
            <CardHeader className="space-y-1">
                ...
                <CardDescription className="text-muted-foreground">Enter your information below to get started</CardDescription>
            </CardHeader>
            <CardContent>
                <form onSubmit={handleSubmit}>
                    <FieldGroup className="gap-4">
                        ...
                        <div className="flex items-start space-x-3 pt-2">
                            <Checkbox id="marketing-consent" name="marketing-consent" defaultChecked className="mt-1" />
                            <Label htmlFor="marketing-consent" className="text-sm text-muted-foreground leading-snug cursor-pointer">
