...
export const VerifyEmail = ({ 
  ...
  return (
    <EmailLayout previewText="Verify your email address to unlock fresh bakes! 🥐" unsubscribeUrl={unsubscribeUrl}>
      <Text style={{
      ...
      <Text style={{
        ...
        This verification link will expire in **1 hour**. If the button above doesn't work, copy and paste this URL into your browser:
        <br />
        <Link href={verificationUrl} style={{ color: theme.colors.primary, textDecoration: "underline" }}>
          {verificationUrl}
        </Link>
      </Text>
    </EmailLayout>
